# Original Definition of Graph Class, not for HW7
...
class Graph:
    ...
    def allDFS(self):
        ...
        for s in self.vertexList:
            ...
            self.dfsPos = 1 #递归深度--第一次抵达的时间（初值为1）
            self.dfsNum = [1] * numVertices #一个存储各个节点的抵达时间的列表
            self.finishingTime = 1 #完成时间--backtrack的时候开始处理这个变量
